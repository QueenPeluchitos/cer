...
<head>
    ...
    <script src="js/carrito_compra.js7"></script>
    <title>Volkswagen | APZ</title>
...
<ul class="vertical-menu">
  ...
  <li><a href="Domicilio.html">Domicilio</a></li>
     ...
     <div class="carousel">     
       <ul>
     <li><img src="imagenes/carousel/volsk.png"></li>
     </ul>
     </div>
    <body>
...
<div class="products-container">
  ...
  <?php
           ...
           WHERE marca.nombre_marca = 'Ayinger' AND producto.departamento_id=1
           ";
...
<?php
              ...
              $sql = "SELECT p.id, p.url_local, p.volumen, pais.nombre_pais, estilo.nombre_estilo_cerveza, sub_estilo.nombre_sub_estilo_cerveza, p.estrellas, p.precio, p.descripcion
                       ...
                       WHERE marca.nombre_marca = 'Ayinger' AND p.departamento_id = 1";
