...
<head>
    ...
    <title>Coolers | Cerveceria SIPP</title>
    ...
    <div class="container">
       ...
       <div class="products-container">
         ...
         <?php
            ...
            FROM producto
            WHERE producto.departamento_id=3
            ";
    ...
    <div class="products-preview">
      ...
      <?php
                                    ...
                                    $sql = "SELECT p.id, p.url_local, color_cooler.nombre_color,  p.estrellas, p.capacidad_cooler, p.voltaje_cooler, p.descripcion, p.precio
                                             FROM producto AS p
                                             INNER JOIN color_cooler ON p.color_cooler_id = id_cooler
                                             WHERE  p.departamento_id = 3";
                                    ...
                                    if ($result->num_rows > 0) {
                                       ...
                                       while($row = $result->fetch_assoc()) {
                                          ...
                                          echo '<h3>Color: ' . $row["nombre_color"] . '<br>';
                                          echo 'Capacidad: ' . $row["capacidad_cooler"] . '<br>';
                                          echo 'Voltaje: ' . $row["voltaje_cooler"] . '<br>';
