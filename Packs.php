...
<head>
    ...
    <title>Beerpacks | Cerveceria SIPP</title>
...
<ul class="vertical-menu">
    ...
    <li><a href="Domicilio.html">Domicilio</a></li>
     ...
     <div class="carousel">     
       <ul>
     <li><img src="imagenes/carousel/pak.png"></li>
     </ul>
     </div>
    <body>
    ...
    <div class="container">
       ...
       <div class="products-container">
         ...
         <?php
               ...
               WHERE producto.nombre LIKE '%pack%' AND producto.departamento_id=1
               ";
    ...
    <div class="products-preview">
      ...
      <?php
                                 ...
                                 $sql = "SELECT p.id,p.nombre ,p.url_local, p.volumen, pais.nombre_pais, estilo.nombre_estilo_cerveza, sub_estilo.nombre_sub_estilo_cerveza, p.estrellas, p.precio, p.descripcion
                                          FROM producto AS p
                                          ...
                                          WHERE p.nombre LIKE '%pack%' AND p.departamento_id = 1";
