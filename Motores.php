...
<ul class="vertical-menu">
  ...
  <li><a href="">Por tipo ></a>
    <ul>
    <li><a href="http://localhost/cer/claras.php">Motores</a></li>
    <li><a href="http://localhost/cer/oscuras.php">Frenos</a></li>
    <li><a href="http://localhost/cer/Ambar.php">Suspencion</a></li>
    <li><a href="http://localhost/cer/Ambar.php">Exterior</a></li>
    <li><a href="http://localhost/cer/Ambar.php">Interior</a></li>
    </ul>
  </li>
  <li><a href="">Por marca ></a>
    <ul>
    <li><a href="http://localhost/cer/labru.php">Toyota</a></li>
    <li><a href="http://localhost/cer/delirium.php">Ford</a></li>
    <li><a href="http://localhost/cer/wendlandt.php">Honda</a></li>
    <li><a href="http://localhost/cer/ramuri.php">Chevrolet</a></li>
    <li><a href="http://localhost/cer/Ayinger.php">Volkswagen</a></li>
    <li><a href="http://localhost/cer/chouffe.php">BMW</a></li>
    <li><a href="http://localhost/cer/gooseisland.php">Audi </a></li>
    <li><a href="http://localhost/cer/kastel.php">Toyota </a></li>
    </ul>
  </li>
  </ul>
  </li>
  ...
  <li><a href="Domicilio.html">Domicilio</a></li>
     ...
     <div class="carousel">     
       <ul>
     <li><img src="imagenes/carousel/motores.jpg"></li>
     </ul>
     </div>
    <body>
    ...
    <div class="container">
       ...
       <div class="products-container">
         ...
         <?php
            ...
            WHERE tipo_cerveza.nombre_tipo_cerveza = 'Clara' AND producto.departamento_id=1
            ";
    ...
    <div class="products-preview">
      ...
      <?php
                              ...
                              $sql = "SELECT p.id, p.url_local, p.volumen, pais.nombre_pais, estilo.nombre_estilo_cerveza, sub_estilo.nombre_sub_estilo_cerveza, p.estrellas, p.precio, p.descripcion
                                       ...
                                       WHERE tipo_cerveza.nombre_tipo_cerveza = 'Clara' AND p.departamento_id = 1";
